    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, SecurityFilter filter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorization -> {
                    ...
                    authorization.requestMatchers(HttpMethod.POST, "/api/coordenadores/**").hasRole("COORDENADOR");
                    authorization.requestMatchers(HttpMethod.POST, "/api/professor/**").hasRole("PROFESSOR");
                    authorization.requestMatchers(HttpMethod.POST, "/api/alunos/**").hasRole("ALUNO");
